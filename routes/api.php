...
Route::group(['namespace' => 'Api'], function()
{
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    Route::delete('/plan_days/{id}/exercises/{exercise_instance_id}', 'PlanDaysController@destroy_exercise');
    Route::put('/plan_days/{id}/exercises', 'PlanDaysController@update_exercises');
